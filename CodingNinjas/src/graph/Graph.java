...
public class Graph {
	...
	public static ArrayList<Integer> getPath2(int edges[][],int sv,int ev)
	{
		...
		for(int i=0;i<n;i++)
		{
			if(!visited[i])
			{
				...
				ArrayList<Integer>ans= getPathHelper2(edges, sv, ev, visited,list);
				if(ans!=null )
				{
	...
	public  static ArrayList<Integer> getPathHelper2(int edges[][],int sv,int ev,boolean visited[],ArrayList<Integer>list)
	{
		...
		for(int i=0;i<edges.length;i++)
		{
			...
			{ 
				 ...
				 ArrayList<Integer>ans= getPathHelper2(edges, i, ev, visited,list);
				 if(ans!=null ) 
				 {
					ans.add(sv);
					 return ans;
	...
	public static void main(String[] args) {
		...
		// 6 5 0 1 1 3 3 4 4 2 2 5  2 0
		// 7 6 1 2 2 3 3 1 4 6 6 5 5 4 
		// 6 5 0 1 1 3 0 2 2 4 4 5
